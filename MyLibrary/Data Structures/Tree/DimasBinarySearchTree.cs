...
{
    internal class BinaryNode<TKey, TValue> where TKey : IComparable<TKey>
    {
    ...
    public class DimasBinarySearchTree<TKey, TValue> where TKey : IComparable<TKey>
    {
        private BinaryNode<TKey, TValue> _root;
        public int Count { get; private set; }

        public DimasBinarySearchTree()
        {
            Count = 0;
        }
