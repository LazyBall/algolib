...
namespace Trees
{
    internal class AVLNode<TKey, TValue> where TKey : IComparable<TKey>
    {
    ...
    public class DimasAVLTree<TKey, TValue> : IDictionary<TKey,TValue>
        where TKey : IComparable<TKey>
    {
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                return (node != null) ? node.Value : throw new ArgumentException();
            }
            set
            {
                var node = Find(key, _root);
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            {
                parent.Left = node;
                BalanceAfterAdding(node.Parent, 1);
            }
            else
            {
                parent.Right = node;
        ...
        private void BalanceAfterAdding(AVLNode<TKey, TValue> node, int balance)
        {
            while (node != null)
            {
